...
namespace GameLib
{
    ...
    class Sprite
    {
        ...
        ID3D11PixelShader*          pixelShader_light;
        ID3D11PixelShader*          pixelShader_Opacity;
    ...
    public:
        ...
        //  スプライト2描画
        //--------------------------------------------------------------
        void render2(ID3D11DeviceContext*,
            const VECTOR2&, const VECTOR2&,
            const VECTOR2&, const VECTOR2&,
            const VECTOR2&, float,
            const VECTOR4&
       ...
       //  スプライト3描画
       //--------------------------------------------------------------
        void render3(ID3D11DeviceContext*,
            const VECTOR2&, const VECTOR2&,
            const VECTOR2&, const VECTOR2&,
            const VECTOR2&, float,
            const VECTOR4&, float
        ...
        struct ConstantBuffer {
            VECTOR4 light[4000]; //ライト位置
            int light_count; //ライト数
            VECTOR3 adjust;//メモリ調整用(空)
        };
