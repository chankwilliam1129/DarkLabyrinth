...
//#define GAMELIB_PLUS_UP // Y軸上が正
    ...
    namespace system
    {
        static const float SCREEN_WIDTH = 1920.0f;  // スクリーンの幅
        static const float SCREEN_HEIGHT = 1080.0f;  // スクリーンの高さ
    ...
    //--------------------------------------------------------------
    void sprite_load(Sprite**, const wchar_t*, int nBufSize = ( 4 ));
